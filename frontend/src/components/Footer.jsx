    ...
    <footer className="bg-black text-white py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          {/* Brand Column */}
          <div>
            <h3 className="text-2xl font-bold mb-4">{personalInfo.username}</h3>
              ...
              {contact.social.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 bg-gray-800 hover:bg-white hover:text-black rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110"
